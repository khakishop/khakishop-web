...
export const blindProducts: Product[] = [
  {
    ...
    title: '프리미엄 베네치안 컬렉션',
    description:
      '고급 알루미늄 소재의 베네치안 블라인드로 정밀한 빛 조절과 내구성을 제공합니다.',
  ...
  },
  {
    ...
    title: '모던 버티컬 시스템',
    description:
      '세련된 수직 블라인드로 넓은 창문과 슬라이딩 도어에 완벽한 솔루션을 제공합니다.',
    ...
    installation: ['헤드레일 천장 고정', '루버 높이 조절', '바닥 체인 고정'],
    care: ['정기적인 진공청소', '물걸레질 (PVC 루버)', '패브릭 드라이클리닝'],
  ...
  },
  {
    ...
    title: '스마트 롤러 컬렉션',
    description:
      '모터라이즈드 시스템과 다양한 원단 옵션을 제공하는 현대적인 롤러 블라인드입니다.',
    ...
    installation: ['전동 모터 설치', '전원 연결 작업', '앱 페어링 설정'],
    care: ['부드러운 브러시 사용', '모터 부분 물기 주의', '정기 점검 서비스'],
  ...
  },
  {
    ...
    title: '엘레강트 로만 스타일',
    description:
      '클래식한 로만 블라인드로 우아한 주름과 고급스러운 분위기를 연출합니다.',
    ...
    installation: ['상부 브라켓 고정', '로드 설치', '주름 조절'],
    care: ['정기적인 진공청소', '전문 드라이클리닝', '직사광선 주의'],
  ...
  },
  {
    ...
    title: '컨템포러리 패널 시스템',
    description:
      '대형 창문과 공간 분할을 위한 모던한 패널 블라인드 시스템입니다.',
    ...
    installation: ['천장 트랙 설치', '패널 높이 조절', '동작 테스트'],
    care: ['정기적인 진공청소', '패브릭 드라이클리닝', '트랙 윤활 관리'],
...
export const getBlindProductsBySubcategory = (
  subcategory: string
): Product[] => {
