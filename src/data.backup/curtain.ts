...
export const curtainProducts: Product[] = [
  {
    ...
    description:
      '천연 리넨 소재로 제작된 에센셜 컬렉션입니다. 자연스러운 질감과 부드러운 드레이프가 공간에 편안함과 세련됨을 더해줍니다.',
  ...
  },
  {
    ...
    description:
      '현대적인 공간에 완벽한 모던 쉬어 커튼입니다. 부드러운 빛 투과로 프라이버시를 보호하면서도 자연광을 적절히 유입시켜 밝고 쾌적한 실내 환경을 만들어줍니다.',
  ...
  },
  {
    ...
    description:
      '베네치안 스타일에서 영감을 받은 프리미엄 커튼 라인입니다. 풍부한 질감과 깊이 있는 색상으로 공간에 고급스러움과 우아함을 선사합니다.',
  ...
  },
  {
    ...
    description:
      '천연 나무의 질감을 모티브로 한 독특한 텍스처 커튼입니다. 자연친화적인 패턴과 부드러운 촉감으로 공간에 따뜻함과 안정감을 제공합니다.',
  ...
  },
  {
    ...
    description:
      '최신 IoT 기술이 적용된 스마트 커튼 시스템입니다. 앱으로 제어하거나 음성 명령으로 조작할 수 있으며, 시간에 따른 자동 개폐 기능과 날씨 연동 기능을 제공합니다.',
...
export const getCurtainProductsBySubcategory = (
  subcategory: string
): Product[] => {
  return curtainProducts.filter(
