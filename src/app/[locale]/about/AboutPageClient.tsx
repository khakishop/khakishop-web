  ...
  const coreValues = [
    {
      ...
      description:
        '고객만의 독특한 취향과 라이프스타일을 반영한 맞춤형 텍스타일 솔루션을 제공합니다.',
    },
    {
      title: '감성',
      subtitle: 'Emotion',
      description:
        '공간에 따뜻함과 아름다움을 더하는 감성적 디자인으로 일상의 특별함을 만들어갑니다.',
    },
    {
      title: '신뢰성',
      subtitle: 'Reliability',
      description:
        '오랜 경험과 전문성을 바탕으로 고품질의 제품과 완벽한 시공 서비스를 약속드립니다.',
    },
  ];
            ...
            <motion.div variants={itemVariants} className="space-y-12">
              ...
              <div className="space-y-8">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  ...
                  각각의 공간이 가진 고유한 특성과 거주자의 라이프스타일을 깊이
                  이해하여, 그에 맞는 최적의 텍스타일 솔루션을 제공합니다.
                </p>

                <p className="text-lg text-gray-600 leading-relaxed">
                  정교한 디자인과 뛰어난 품질, 그리고 전문적인 시공을 통해
                  고객의 공간을 더욱 특별하고 아름답게 만드는 것이 우리의
                  사명입니다.
                </p>
              </div>
            </motion.div>
          ...
          <div className="max-w-screen-xl mx-auto px-6">
            <motion.div variants={itemVariants} className="text-center mb-20">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                카키샵이 추구하는 세 가지 핵심 가치를 통해 고객에게 최상의
                경험을 제공합니다.
              </p>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="space-y-12">
              ...
              <div className="space-y-8">
                <p className="text-xl lg:text-2xl text-gray-600 font-light italic leading-relaxed">
                  "공간은 단순한 물리적 영역이 아닙니다. 그곳은 삶이 펼쳐지고,
                  추억이 만들어지며, 꿈이 자라나는 무대입니다."
                </p>

                <p className="text-lg text-gray-600 leading-relaxed">
                  카키샵은 이러한 철학을 바탕으로 텍스타일을 통해 공간의
                  가능성을 극대화하고, 고객의 일상에 더 많은 아름다움과 편안함을
                  가져다주고자 합니다.
                </p>
              </div>
            </motion.div>
