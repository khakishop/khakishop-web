...
import { getProjectMainImageUrl, getReferenceImagePaths } from '../../../../utils/imageUtils';
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      title: `${project.title} | 시공사례 | khaki shop`,
      description: `${project.description} 위치: ${project.location}`,
      url: `https://khakishop.kr/ko/reference/${params.slug}`,
      siteName: 'khaki shop',
      images: [
        {
          url: mainImageUrl,
        ...
        <div className="border-t border-gray-100 pt-16">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <button
                onClick={() => window.open("https://m.booking.naver.com/booking/13/bizes/966895", "_blank")}
