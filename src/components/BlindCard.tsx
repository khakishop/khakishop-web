...
// ================================================================================
// 🚀 성능 최적화된 블라인드 카드 컴포넌트
// ================================================================================

const BlindCard = memo(function BlindCard({ product, locale = 'ko' }: BlindCardProps) {
  // ================================================================================
  // 📊 메모이제이션된 계산
  // ================================================================================
  ...
  const productUrl = useMemo(() => {
    return `/${locale}/blind/${product.slug}`;
  }, [locale, product.slug]);
          ...
          <div className="absolute top-4 left-4 flex flex-col gap-2">
            ...
            {product.new && (
              <motion.span
                ...
                className="bg-gradient-to-r from-emerald-400 to-teal-500 text-white px-3 py-1 text-xs font-bold rounded-full shadow-lg"
              >
                NEW
              </motion.span>
            )}
...
BlindCard.displayName = 'BlindCard';
