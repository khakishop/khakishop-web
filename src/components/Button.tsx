...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses =
    'inline-flex items-center justify-center font-serif tracking-wide transition-all duration-300 group';

  const variantClasses = {
    primary: 'bg-neutral-800 text-white hover:bg-neutral-700 rounded-full',
    secondary:
      'text-neutral-900 hover:text-neutral-600 border border-neutral-300 hover:border-neutral-900 rounded-full',
