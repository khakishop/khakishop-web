...
export const galleryItems: GalleryItem[] = [
  {
    ...
    description: '현대적인 감각의 커튼 컬렉션. 미니멀한 디자인과 기능성을 완벽하게 조화시킨 작품들입니다.',
    category: 'Curtain',
    tags: ['모던', '미니멀', '리넨', '자연광'],
  ...
  },
  {
    ...
    description: '베네치안 블라인드의 클래식한 아름다움. 정밀한 빛 조절과 우아한 디자인의 만남입니다.',
    category: 'Blind',
  ...
  },
  {
    ...
    description: '스마트 홈 자동화 시스템의 미래. IoT 기술로 구현한 지능형 창호 솔루션입니다.',
    category: 'Motorized',
  ...
  },
  {
    ...
    description: '자연과 조화를 이루는 인테리어 공간. 카키샵의 감성적 접근법이 돋보이는 작품입니다.',
    category: 'Interior',
  ...
  },
  {
    ...
    description: '일상 속 특별한 순간들. 카키샵 제품과 함께하는 라이프스타일을 담은 감성적인 이미지들입니다.',
    category: 'Lifestyle',
...
export const getAllGalleryItems = (): GalleryItem[] => {
  return galleryItems.sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime());
};
