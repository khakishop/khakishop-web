  ...
  return (
    <>
      ...
      <div className="fixed top-6 right-6 z-50 flex items-center space-x-4">
        ...
        <span 
          onClick={toggleMenu}
          className="text-sm sm:text-base font-medium tracking-wide cursor-pointer text-black hover:opacity-70 transition-opacity"
        >
          {isOpen ? 'CLOSE' : 'MENU'}
        </span>
        ...
        <div 
          onClick={toggleMenu}
          className="w-3.5 h-3.5 bg-black rounded-full cursor-pointer hover:opacity-70 transition-opacity"
        />
