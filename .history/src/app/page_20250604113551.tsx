      ...
      <section className="relative h-screen">
        ...
        <div className="relative h-full flex items-center justify-center z-10">
          ...
          >
            ...
            >
              <div className="border-[1px] border-white text-white px-12 py-6 text-2xl md:text-3xl font-light tracking-wide uppercase transition-all duration-300 ease-in-out hover:bg-white hover:text-black">
                OUR PROJECTS
              </div>
            </Link>
          </motion.div>
