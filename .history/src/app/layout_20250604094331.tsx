...
export default function RootLayout({
  ...
  return (
    <html lang="ko">
      <body className={`${inter.className} ${montserrat.variable} ${dmSerifDisplay.variable} bg-white text-neutral-900`}>
        {/* ✅ 상단 메뉴 */}
        <header className="w-full px-6 py-4 flex justify-end items-center border-b">
        ...
        <footer className="bg-white border-t border-gray-100 text-[#111111] py-16 px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-8">
              <p className="text-sm text-gray-600">영감을 주는 생활을 위한 창의적인 가구</p>
            </div>

            {/* Copyright */}
            <div className="text-center">
              <p className="text-xs text-gray-500 tracking-wider">© 2025 KHAKI SHOP • by YOURAGENCY</p>
            </div>
          </div>
        </footer>
      </body>
