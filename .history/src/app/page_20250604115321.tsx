    ...
    <div className="bg-white">
      ...
      <section ref={heroRef} className="relative h-screen -mt-16">
        ...
        <motion.div
          ...
          className="absolute bottom-0 left-1/2 transform -translate-x-1/2 z-10 pb-12"
        >
          <h1 className="text-[8vw] font-bold tracking-tight leading-none text-white text-center whitespace-nowrap">
            Design Beyond Time
          </h1>
        </motion.div>
      </section>
