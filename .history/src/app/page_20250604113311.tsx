  ...
  return (
    <div className="bg-white">
      ...
      <section ref={heroRef} className="relative h-screen -mt-16">
        ...
        >
          <h1 className="text-white font-extrabold text-[96px] md:text-[144px] lg:text-[240px] leading-none tracking-tight text-center">
            Design Beyond Time
          </h1>
        </motion.div>
      </section>
      ...
      <section className="relative h-screen">
        ...
        <div className="relative h-full flex items-center justify-center z-10">
          ...
          >
            ...
            >
              <div className="border-2 border-white text-white px-12 py-6 text-2xl md:text-3xl font-light tracking-widest uppercase transition-all duration-500 ease-in-out hover:bg-white hover:text-black transform hover:scale-105 hover:shadow-2xl">
